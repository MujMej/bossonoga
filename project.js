    ...
    packages: [
        {
            ...
            price: 0,
            displayPrice: 'Kreiraj paket',
            category: 'packages',
            description: 'Kreirajte poklon paket tako što birate više proizvoda i način pakovanja.',
            shortDescription: 'Odaberite proizvode, pakovanje i karticu po želji.',
            details: 'Korisnik bira proizvode iz Bossonoga ponude, zatim opciju pakovanja: bez posebne ambalaže, samo poklon pakovanje (+2 KM) ili poklon pakovanje uz ručno rađenu karticu (+5 KM). Nakon toga unosi kome je poklon, povod i instrukcije za karticu, pa se cijeli paket dodaje u korpu kao jedna stavka.',
            icon: 'fa-gift',
            limited: false,
            custom: true,
            image: 'images/bathbomb-main.png'
